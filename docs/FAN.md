...
| Code | Supported Models | Controller |
| ------------- | -------------------------- | ------------- |
[2000](../codes/fan/2000.json)|F-56XPG|Broadlink
